...
public class ViewIntgTestPage extends AbstrIntgTestPage {

	public ViewIntgTestPage(WebDriver driver, Wait<WebDriver> wait) {
		super(driver, wait);
	}
	...
	public void checkIfPageLoaded() {
        ...
        assertEquals("Hello World - View", title);
