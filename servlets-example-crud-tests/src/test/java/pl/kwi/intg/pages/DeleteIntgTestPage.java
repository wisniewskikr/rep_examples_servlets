...
public class DeleteIntgTestPage extends AbstrIntgTestPage {

	public DeleteIntgTestPage(WebDriver driver, Wait<WebDriver> wait) {
		super(driver, wait);
	}
	...
	public void checkIfPageLoaded() {
        ...
        assertEquals("Hello World - Delete", title);
