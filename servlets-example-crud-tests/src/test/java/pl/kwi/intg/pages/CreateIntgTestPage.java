...
public class CreateIntgTestPage extends AbstrIntgTestPage {

	public CreateIntgTestPage(WebDriver driver, Wait<WebDriver> wait) {
		super(driver, wait);
	}
	...
	public void checkIfPageLoaded() {
        ...
        assertEquals("Hello World - Create", title);
