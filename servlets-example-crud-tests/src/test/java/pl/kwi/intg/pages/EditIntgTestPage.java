...
public class EditIntgTestPage extends AbstrIntgTestPage {

	public EditIntgTestPage(WebDriver driver, Wait<WebDriver> wait) {
		super(driver, wait);
	}
	...
	public void checkIfPageLoaded() {
        ...
        assertEquals("Hello World - Edit", title);
